...
object AdventureTextUI extends App:
  ...
  private def printAreaInfo() =
      ...
      if game.voldemort.isDefeated && !player.areHorcruxesDestroyed then
        println("There are Horcruxes that have not been destroyed. Come back to the rooms and destroy them before Voldemort respawn!!!")
